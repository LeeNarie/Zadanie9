...
namespace zadanie5
{
    public class Student
    {
       ...
       public string FIO
        ...
        public static void ChangeStudent(int id, string Fio, string group, string data)
        {
            foreach (Student o in students)
            {
                if (id == (int)o.studinfo[0])
                {
                    o.ChangeFio(Fio);
                    o.ChangeGroup(group);
                    o.ChangeData(data);
        ...
        {
            List<Student> tmpList = new List<Student>(students);


            foreach (Student o in tmpList)
                {
                    if (id == (int)o.studinfo[0])
                    {
                        students.Remove(o);
        ...
        static public void WriteAll(List<Student> st)
        {
            ...
            {
                Console.WriteLine("ID: "+ o.studinfo[0]);
                StudentWriteFio(o);
            }
        }
        ...
        static public void WriteAllInfo()
        {
            foreach (Student o in students)
            {
                    o.StudentWrite();
        ...
        static public void WriteAllFioShort()
        {
            foreach (Student o in students)
            {
                StudentWriteFioShort(o);
            }
        }
